...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E01.1 | TODO | P0 | Mourad | Ibrahim | Sprint 0 | none | Modele `Event` | Schema logique evenement documente | Les attributs obligatoires et optionnels d'un evenement sont stabilises | `docs/event-model-core` |
| E01.2 | TODO | P0 | Mourad | Ibrahim | Sprint 0 | E01.1 | Etats `Event` | Machine d'etat evenement documentee | Les transitions `DRAFT`, `PUBLISHED`, `FULL`, `CLOSED`, `ARCHIVED`, `CANCELLED` sont explicites | `docs/event-status-machine` |
...
| Ticket ID | Status | Priority | Owner | Support | Sprint cible | Dependances | Interfaces impactees | Sortie attendue | Critere d'acceptation | Branche suggeree |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E02.1 | TODO | P0 | Mourad | Ibrahim | Sprint 0 | E01.1 | REST create/update/list drafts | Contrats CRUD brouillon documentes | Les payloads create/update/list et les erreurs de validation sont figes | `docs/event-draft-crud-contract` |
| E02.2 | TODO | P0 | Mourad | Ibrahim | Sprint 1 | E02.1 | Service Event Management | CRUD brouillon implementable | La creation, mise a jour et consultation des brouillons sont prêtes a coder | `feature/event-draft-crud` |
| E02.3 | TODO | P0 | Mourad | Ibrahim | Sprint 1 | E02.2 | Validation dates/capacite | Regles de validation et smoke tests | Les cas date invalide, capacite incoherente et champ manquant sont couverts | `feature/event-draft-validation` |
...
| Ticket ID | Status | Priority | Owner | Support | Sprint cible | Dependances | Interfaces impactees | Sortie attendue | Critere d'acceptation | Branche suggeree |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E03.1 | TODO | P0 | Mourad | Ibrahim | Sprint 0 | E01.2 | REST publish, event `event.published` | Contrat de publication documente | Les cas publication immediate et differee ont un payload et des erreurs explicites | `docs/event-publication-contract` |
| E03.2 | TODO | P0 | Mourad | Ibrahim | Sprint 1 | E03.1, E02.2 | Publication immediate | Publication immediate implementable | Un brouillon valide passe a `PUBLISHED` et emet `event.published` | `feature/event-publish-now` |
...
| Ticket ID | Status | Priority | Owner | Support | Sprint cible | Dependances | Interfaces impactees | Sortie attendue | Critere d'acceptation | Branche suggeree |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E05.1 | TODO | P1 | Ibrahim | Mourad | Sprint 0 | E01.2 | Reponse liste organisateur | Contrat de listing organisateur documente | Les colonnes, filtres et compteurs de la vue "Mes evenements" sont figes | `docs/organizer-events-list-contract` |
| E05.2 | TODO | P1 | Mourad | Ibrahim | Sprint 1 | E05.1, E02.2 | REST list organizer events | Backend listing implementable | Les evenements sont filtrables par statut, date et theme avec pagination | `feature/organizer-events-list-api` |
| E05.3 | TODO | P1 | Ibrahim | Mourad | Sprint 1 | E05.1, F03.1 | Back-office organisateur | Vue "Mes evenements" implementable | Les compteurs et filtres affichent uniquement les evenements de l'organisateur courant | `feature/organizer-events-list-ui` |
...
| Ticket ID | Status | Priority | Owner | Support | Sprint cible | Dependances | Interfaces impactees | Sortie attendue | Critere d'acceptation | Branche suggeree |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| E06.1 | TODO | P1 | Mourad | Ibrahim | Sprint 0 | E03.1 | REST cancel event, event `event.cancelled` | Contrat d'annulation documente | Les effets sur catalogue, inscriptions et notifications sont explicitement notes | `docs/event-cancel-contract` |
| E06.2 | TODO | P1 | Mourad | Ibrahim | Sprint 1 | E06.1, R03.2 | Flux annulation evenement | Annulation evenement implementable | Un evenement annule met a jour son statut et emet les evenements derives attendus | `feature/event-cancel-flow` |
