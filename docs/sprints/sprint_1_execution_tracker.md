...
- Last updated: `2026-04-10T20:57:00.339Z`
...
| S1-T05 | DONE | P0 | S1-M02, E02.2, E02.3, I04.2 | S1-M02 implementation start: scaffold event-management-service with Postgres and implement POST/GET/PATCH/DELETE /api/events/drafts* + ownership rules. | 2026-04-10T20:57:00.339Z |
...
- `S1-T05` `DONE` (2026-04-10T20:57:00.339Z): Expanded the demo seed set with extra cancelled registrations, more organizer events, soft-deleted/archive event rows, and notification-heavy scenarios; verified the database now has 7 events, 11 registrations, 3 tickets, 9 notifications, and 4 payments.
