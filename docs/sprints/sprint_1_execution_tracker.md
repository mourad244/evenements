...
- Last updated: `2026-03-26T21:05:13.345Z`
...
| S1-T03 | IN_PROGRESS | P1 | S1-M01, M01.2, M02.3 | Add docker-compose and CI job to run test:s1-m01 automatically. | 2026-03-26T21:05:13.345Z |
| S1-T04 | DONE | P1 | S1-M06, M02.2, M02.3 | S1-M06 hardening on current services: structured logs + guaranteed x-correlation-id tracing on every auth path (Gateway + Identity), plus smoke assertions. | 2026-03-09T00:45:47.779Z |
...
- `S1-T03` `IN_PROGRESS` (2026-03-26T21:05:13.345Z): Fixing GitHub Actions s1-m01-smoke install failure caused by pnpm-lock.yaml being out of date with apps/docs-portal/package.json.
