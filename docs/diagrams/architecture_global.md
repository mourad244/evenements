---
title: Diagramme architecture globale
description: Rendu Mermaid de l'architecture globale P1-P4 du projet Evenements.
docKind: diagram
domain: architecture
phase: P1-P4
owner: Ibrahim
...
tags:
  ...
  - architecture
  - mermaid
slug: architecture-global
---

# Diagramme architecture globale

Source Mermaid canonique: `docs/diagrams/architecture_global.mmd`
