    ...
    <div className="grid gap-6">
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="grid gap-2">
          ...
          <p className="text-sm text-slate-600">
            Registrations that already expose a backend ticket reference.
          </p>
        </Card>
      </div>
      ...
      <Card className="overflow-hidden p-0">
        <div className="grid gap-3 border-b border-slate-100 px-6 py-5 sm:flex sm:items-end sm:justify-between">
          <div className="grid gap-1">
            ...
            <p className="text-sm text-slate-600">
              Review participant status and ticket-reference readiness for this event.
            </p>
          </div>
          ...
          <table className="min-w-full text-left text-sm">
            <thead className="bg-slate-50 text-slate-500">
              <tr>
                ...
                <th className="px-6 py-4 font-medium">Ticket readiness</th>
                ...
                >
                  <td className="px-6 py-4">
                    <div className="grid gap-1">
                      ...
                      <p className="text-xs text-slate-500">Registration ID: {registration.id}</p>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-slate-600">
                    {registration.ticketRef ? "Reference available" : "Ticket not issued yet"}
                  </td>
                  <td className="px-6 py-4 text-slate-600">
